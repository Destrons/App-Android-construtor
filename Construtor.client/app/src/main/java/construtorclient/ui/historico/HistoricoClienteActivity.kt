...
import com.Construtor.client.databinding.ActivityHistoricoClienteBinding
import com.Construtor.client.model.HistoricoServico

class HistoricoClienteActivity : AppCompatActivity() {

    private lateinit var binding: ActivityHistoricoClienteBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHistoricoClienteBinding.inflate(layoutInflater)
