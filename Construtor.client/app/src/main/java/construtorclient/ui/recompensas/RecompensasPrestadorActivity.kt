...
import com.Construtor.client.databinding.ActivityRecompensasPrestadorBinding
import com.Construtor.client.model.Recompensa

class RecompensasPrestadorActivity : AppCompatActivity() {

    private lateinit var binding: ActivityRecompensasPrestadorBinding
    private val db = FirebaseFirestore.getInstance()
    private val userId = FirebaseAuth.getInstance().currentUser?.uid

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRecompensasPrestadorBinding.inflate(layoutInflater)
